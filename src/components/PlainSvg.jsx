...
const PlainSvgIcon = function ({iconName, assignClass}) {
  ...
  const svgIcons = {
    ...
    navMenu: (
      <svg {...attributes} xmlns='http://www.w3.org/2000/svg' viewBox='0 -2 28 28'>
        <g>
          <path d='M7.184 0H27.65v5.219H7.184zM7.184 9.39H27.65v5.219H7.184zM7.184 18.781H27.65V24H7.184zM0 0h5.219v5.219H0zM0 9.39h5.219v5.219H0zM0 18.781h5.219V24H0z'></path>
        </g>
      </svg>
    ),
    ...
    close: (
      ...
      >
        <g>
          <path d='M20.3 21.7 12 13.4l-8.3 8.3-1.4-1.4 8.3-8.3-8.3-8.3 1.4-1.4 8.3 8.3 8.3-8.3 1.4 1.4-8.3 8.3 8.3 8.3z'></path>
        </g>
      </svg>
    )
